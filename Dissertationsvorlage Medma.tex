...
\KOMAoptions{fontsize=12pt,DIV=calc} %Für druckreifen, zweiseitigen-Satzspiegel die Option "twoside" bei diesem Befehl einfügen und die beiden Befehle in Zeile 34+35 auskommentieren
...
\usepackage{lmodern} %Bessere Standardschriftart
...
\usepackage{array} %verbesserte array und tabular-Umgebung ftp://ftp.fu-berlin.de/tex/CTAN/macros/latex/required/tools/array.pdf
...
\usepackage{lscape} %Querformat-Darstellung einzelner Seiten
\usepackage{pdflscape} %Drehung dieser Seiten im PC in pdf-Readern
\usepackage{booktabs} % publikationsreife Tabellen
...
%=============
% die folgenden zwei Befehle auskommentieren, wenn in Zeile 7 die twoside-Option aktiviert wurde
...
\usepackage{array,booktabs} %Für schönere Tabellen Dokumentation für booktabs: http://www.namsu.de/Extra/pakete/Booktabs.html
...
%--------Für URL-Breaks in der Bibliographie siehe  https://norwied.wordpress.com/2012/07/10/how-to-break-long-urls-in-bibtex/]
\usepackage{url}
...
\begin{acronym}[ABC] %längstes Akronym, wird als Mindestabstand verwendet
	\acro{EH}{Entenhausen}
	\acro{PK}{Panzerknacker}
\end{acronym}
